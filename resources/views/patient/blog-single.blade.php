                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ url('/specialization') }}" id="dropdown02" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">Specialization <i class="icofo	nt-thin-down"></i></a>
    ...
    <div class="col-lg-12 mb-5">
        <div class="single-blog-item">
            ...
            <div class="blog-item-content mt-5">
                ...
                <h2 class="mb-4 text-md"><a href="{{ url('/blog-single') }}">Healthy environment to care with modern equipment</a></h2>
        ...
        <div class="comment-area mt-4 mb-5">
            ...
            <ul class="comment-tree list-unstyled">
                ...
                <li>
                    <div class="comment-area-box d-block d-sm-flex">
                        <div class="comment-thumb">
                            <img alt="" src="{{ asset('Novena/images/blog/testimonial2.jpg') }}" style="width: 70px">
                        </div>
