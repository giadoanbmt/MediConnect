<x-layouts.public title="MediConnect">
<!-- Slider Start -->
			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<div class="btn-container ">
						<a href="{{ url('/appointment') }}" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Make appointment <i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-10 ">
				<div class="appointment-wrap mt-5 mt-lg-0">
                    ...
                    <a class="btn btn-main btn-round-full" href="{{ url('/appointment') }}" >Make appointment <i class="icofont-simple-right ml-2  "></i></a>
                </form>
            </div>
			</div>
		</div>
