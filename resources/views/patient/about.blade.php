<x-layouts.public title="MediConnect - About">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <img src="{{ asset('Novena/images/about/sign.png') }}" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="about-block-item mb-5 mb-lg-0">
                    <img src="{{ asset('Novena/images/about/about-1.jpg') }}" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="about-block-item mb-5 mb-lg-0">
                    <img src="{{ asset('Novena/images/about/about-2.jpg') }}" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="about-block-item mb-5 mb-lg-0">
                    <img src="{{ asset('Novena/images/about/about-3.jpg') }}" alt="" class="img-fluid w-100">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="about-block-item">
                    <img src="{{ asset('Novena/images/about/about-4.jpg') }}" alt="" class="img-fluid w-100">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block mb-5 mb-lg-0">
                    ...
                    <div class="content">
                        <h4 class="mt-4 mb-0"><a href="{{ url('/doctor-single') }}">John Marshal</a></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block mb-5 mb-lg-0">
                    <img src="{{ asset('Novena/images/team/2.jpg') }}" alt="" class="img-fluid w-100">

                    <div class="content">
                        <h4 class="mt-4 mb-0"><a href="{{ url('/doctor-single') }}">Marshal Root</a></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block mb-5 mb-lg-0">
                    <img src="{{ asset('Novena/images/team/3.jpg') }}" alt="" class="img-fluid w-100">

                    <div class="content">
                        <h4 class="mt-4 mb-0"><a href="{{ url('/doctor-single') }}">Siamon john</a></h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-block">
                    <img src="{{ asset('Novena/images/team/4.jpg') }}" alt="" class="img-fluid w-100">

                    <div class="content">
                        <h4 class="mt-4 mb-0"><a href="{{ url('/doctor-single') }}">Rishat Ahmed</a></h4>
