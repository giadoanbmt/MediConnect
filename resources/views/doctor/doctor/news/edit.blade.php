...
<div class="news-create-page">
    ...
    <h1 class="news-create-title">Edit News</h1>
    ...
    <div class="news-create-card">
        ...
        <form
            action="{{ route('doctor.news.update', $news->NewsId) }}"
            method="POST"
        ...
        >
            ...
            <div class="news-form-group">
                ...
                >
                    ...
                    <option
                        value="Health Tips"
                        {{ old('Category', $news->Category) == 'Health Tips' ? 'selected' : '' }}
                    >
                        Health Tips
                    </option>
                    ...
                    <option
                        ...
                        {{ old('Category', $news->Category) == 'Medical Research' ? 'selected' : '' }}
                    >
                        Medical Research
                    </option>
                    ...
                    <option
                        ...
                        {{ old('Category', $news->Category) == 'Healthy Living' ? 'selected' : '' }}
                    >
                        Healthy Living
                    </option>
                    ...
                    <option
                        ...
                        {{ old('Category', $news->Category) == 'Disease Prevention' ? 'selected' : '' }}
                    >
                        Disease Prevention
                    </option>
                </select>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Load content
    const content = @json(old('Content', $news->Content));
