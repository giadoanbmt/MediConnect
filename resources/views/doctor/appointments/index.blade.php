    ...
    <div class="appointments-page">
        ...
        <div class="filter-card">
            ...
            <form method="GET" action="{{ route('doctor.appointments') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="view" class="filter-select">
                            <option value="day" {{ $view === 'day' ? 'selected' : '' }}>
                                Day
                            </option>

                            <option value="week" {{ $view === 'week' ? 'selected' : '' }}>
                                Week
                            </option>

                            <option value="month" {{ $view === 'month' ? 'selected' : '' }}>
                                Month
                            </option>
                        </select>
                ...
                <a href="{{ route('doctor.appointments') }}" class="reset-btn">
                    Reset filters
                </a>
            ...
            @if ($appointments->count())
                ...
                @foreach ($appointments as $appointment)
                    @php
                        ...
                        $statusValue = strtolower($appointment->Status ?? 'unknown');
                    ...
                    <div class="appointment-item">
                        ...
                        <div class="patient-avatar">
                            ...
                            @if ($patient && !empty($patient->AvatarUrl))
                                <img src="{{ asset($patient->AvatarUrl) }}" alt="{{ $patient->FullName }}"
                        ...
                        <div class="appointment-status">
                            ...
                            @if ($statusValue === 'pending')
                                <div class="appointment-actions">
                                    ...
                                    <form method="POST"
                                        ...
                                        <button type="submit" class="appointment-action-btn btn-confirm">
                                            <i class="fas fa-check"></i>
                                            Confirm
                                        </button>
                                    </form>

                                    <button type="button" class="appointment-action-btn btn-cancel"
                                ...
                                <form method="POST"
                                    ...
                                    class="cancel-form" id="cancel-form-{{ $appointment->AppointmentId }}"
                                    style="display:none;">
                                    @csrf

                                    <input type="text" name="CancellationReason"
                                        placeholder="Enter cancellation reason..." maxlength="255" required>

                                    <div class="cancel-form-actions">

                                        <button type="button" class="cancel-close-btn"
                            ...
                            @elseif($statusValue === 'confirmed')
                                ...
                                {{-- Chỉ cho hoàn thành khi đã qua EndTime --}}
                                @php
                                    $endDateTime = \Carbon\Carbon::parse(
                                        $appointment->AppointmentDate . ' ' . $appointment->EndTime
                                    );

                                    $canComplete = now()->greaterThanOrEqualTo($endDateTime);
                                @endphp
                                ...
                                <div class="appointment-actions">
                                    ...
                                    <form method="POST"
                                        ...
                                        <button type="submit"
                                            ...
                                            style="{{ !$canComplete ? 'opacity: .5; cursor: not-allowed;' : '' }}">
