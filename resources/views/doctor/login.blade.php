            ...
            <div class="col-lg-5 col-md-7 col-sm-10">
                <div class="auth-card">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="font-weight-bold mb-4" style="color: #0088cc;">Doctor login</h2>
                        <p class="text-muted small">Welcome back, Doctor.</p>
                    </div>

                    <form action="{{ url('ControllerLogindoctor') }}" method="POST">
                        @csrf
