...
<div class="doctor-availability">
    ...
    <div class="availability-card">
        ...
        @php
            ...
            $weeklyScheduleMap = $schedules->keyBy(function ($schedule) {
        ...
        <div class="weekly-calendar">
            ...
            <div class="week-header">
                ...
                @foreach($weeklyDays as $index => $day)
            ...
            <div class="week-body">
                ...
                @foreach($weeklyDays as $index => $day)
                    ...
                    @php
                        ...
                        $morning = $weeklyScheduleMap->get(
                            $date->format('Y-m-d') . '_08:00'
                        );

                        $afternoon = $weeklyScheduleMap->get(
                            $date->format('Y-m-d') . '_13:00'
                        );
                    ...
                    <div class="day-column">
                        ...
                        <div class="shift-card
                            {{ $morning?->Status === 'Available' ? 'active' : '' }}
                            {{ $morning?->Status === 'Off' ? 'off' : '' }}"
                        >
                            ...
                            @if($morning)
                                ...
                                @if($morning->Status === 'Available')

                                    <div class="shift-status available">
                                        Available
                                    </div>

                                @elseif($morning->Status === 'Off')

                                    <div class="shift-status off">
                                        Day Off
                                    </div>
                                ...
                                @else
                                    ...
                                    <div class="shift-status pending">
                                        {{ $morning->Status }}
                                    </div>
                        ...
                        {{-- Afternoon --}}
                        <div class="shift-card
                            {{ $afternoon?->Status === 'Available' ? 'active' : '' }}
                            {{ $afternoon?->Status === 'Off' ? 'off' : '' }}"
                        >
                            ...
                            @if($afternoon)
                                ...
                                @if($afternoon->Status === 'Available')

                                    <div class="shift-status available">
                                        Available
                                    </div>

                                @elseif($afternoon->Status === 'Off')
            ...
            @forelse($appointments as $appointment)
                ...
                <div class="appointment-card">
                    ...
                    <div class="appointment-avatar">
                        ...
                        @if(
                            $appointment->accountUser &&
                            $appointment->accountUser->AvatarUrl
                        )

                            <img
                                src="{{ asset($appointment->accountUser->AvatarUrl) }}"
                                alt="{{ $appointment->accountUser->FullName }}"
                            >
                    ...
                    <div class="appointment-info">
                        ...
                        <div class="appointment-name">
                            {{ $appointment->accountUser->FullName ?? 'Unknown Patient' }}
                        </div>
