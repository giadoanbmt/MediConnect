...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Edit Doctor Profile</h1>
            <p class="text-slate-500 text-sm">Update doctor details, specialization, and clinic room assignment</p>
        </div>
        ...
        <form action="{{ route('admin.doctors.update', $doctor->DoctorId) }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-4 pt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @php $genderVal = old('gender', $doctor->Gender ?? ''); @endphp
                    ...
                    <div>
                        ...
                        @php $currentSpec = request('specialization_id', old('specialization_id', $doctor->SpecializationId ?? '')); @endphp
                        <select id="specialization_select" name="specialization_id"
                            data-action="{{ route('admin.doctors.edit', $doctor->DoctorId) }}"
                    ...
                    <div>
                        ...
                        @php $currentRoom = old('room_id', $doctor->RoomId ?? ''); @endphp
                    ...
                    <div>
                        ...
                        @php $currentCityName = request('city_name', old('city_name', $doctor->CityName ?? '')); @endphp
                    ...
                    <div>
                        ...
                        @php $currentCityId = old('city_id', $doctor->CityId ?? ''); @endphp
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="address" value="{{ old('address', $doctor->Address ?? '') }}" placeholder="Enter street address, building..."
                            class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-slate-800">
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end pt-4 border-t border-slate-100">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2.5 rounded-lg shadow transition flex items-center">
                    <i class="fa-solid fa-floppy-disk mr-2"></i> Update Doctor Profile
                </button>
            </div>
        </form>
    </div>
